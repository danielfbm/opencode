...
export default function Layout(props: ParentProps) {
  ...
  createEffect(() => {
    const sidebarWidth = layout.sidebar.opened() ? 256 : 0
    document.documentElement.style.setProperty("--dialog-left-margin", `${sidebarWidth}px`)
  })

  // createEffect(() => {
  //   // Force set width to match design
  //   if (layout.sidebar.width() !== 240 && layout.sidebar.opened()) {
  //        layout.sidebar.setWidth(240)
  //   }
  // })
